...
*/			request.getSession().setAttribute("empCode", principal.getName());
	...
	public String getAllprojects(Model model, HttpServletRequest request) {
		...
		System.out.println("dsasdsadsdasda"+employee.getEmpCode());
		model.addAttribute("employees",
				employeeService.getEmployeeByIdString(employee.getEmpCode()));
	...
	public String editEmployee(Model model,
		...
		Employee employeeToEdit = employeeService
				.getEmployeeByIdString(empCode);
	...
	public ModelAndView search(ModelAndView modelAndView,
		...
		employeeSkillService.addSkillsToEmployee(request.getSession()
				.getAttribute("empCode").toString(), skills);
