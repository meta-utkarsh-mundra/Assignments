...
public class TestUnit {
	...
	/**fourth, negative test case for maximum mirror
	 * 
	 */
	@org.junit.Test
	public void mirrorTestFourth() {
		int count = mirror_object.maxMirror(new int[]{1, 2, 1, 4});
	...
	/**fourth, negative test case for clumps
	 * 
	 */
	@org.junit.Test
	public void clumpsFourth() {
		int count = clumps_object.totalClumps(new int[]{1, 1, 1, 4});
		assertNotEquals(5, count);
	}
