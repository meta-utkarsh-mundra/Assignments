...
public class TriangleServiceLocator extends org.apache.axis.client.Service implements com.metacube.webService.soap.TriangleService {
    ...
    private java.lang.String Triangle_address = "http://localhost:8080/EAD-Session-6/services/Triangle";
    ...
    public com.metacube.webService.soap.Triangle getTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.webService.soap.TriangleSoapBindingStub _stub = new com.metacube.webService.soap.TriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.webService.soap.Triangle.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.webService.soap.TriangleSoapBindingStub _stub = new com.metacube.webService.soap.TriangleSoapBindingStub(new java.net.URL(Triangle_address), this);
                _stub.setPortName(getTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap.webService.metacube.com", "TriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap.webService.metacube.com", "Triangle"));
        }
