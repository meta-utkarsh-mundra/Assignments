...
public class TestLargestValue {
	...
	public void testLargestValue() {
		...
		int result = operations.largestValue(nestedList);
		assertEquals("largest value is 8 ", 8, result);

	}

	@Test
	public void test2LargestValue() {
		nestedList.remove(5);
		System.out.println("list for test2 : " + nestedList.toString());
		int result = operations.largestValue(nestedList);
		assertEquals("largest value is 5 ", 6, result);
